let config = {
	...
	contentColorBG: "#7b7ba6",
	containerColorBG: "#d1d3ff",
...
function createTitle(){
	document.body.title.valueOf = "Star Breaker"
}
...
function createScore () {
	components.score.style.width = "200px"
	components.score.style.height = "50px"
	...
	components.score.style.fontSize = "24px";
